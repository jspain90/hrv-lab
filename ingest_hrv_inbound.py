...
# CONFIG
# =====================
DB_PATH         = Path("hrv_lab.sqlite3")
INBOUND_DIR     = Path("data_pipeline/io/inbound")
ARCHIVE_DIR     = Path("data_pipeline/io/archive")
QUARANTINE_DIR  = Path("data_pipeline/io/quarantine")
